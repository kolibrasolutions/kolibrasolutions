  ...
  return <Layout>
      <div className="container mx-auto px-4 py-12">
        ...
        {loading ? <div className="flex justify-center my-8">
          ...
          </div> : !post ? <div className="bg-green-50 p-8 rounded-lg text-center">
            ...
            {post.image_url && <div className="mb-8">
                <img src={post.image_url} alt={post.title} className="w-full h-auto rounded-lg object-cover max-h-[400px]" />
              </div>}
